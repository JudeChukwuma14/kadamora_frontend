...
const SuccessPrompt: React.FC<SuccessPromptProps> = ({ done }) => {
    ...
    return (
        <div className="w-full sm:w-[520px] max-w-[100vw] bg-white rounded-2xl shadow-xl overflow-hidden">
            <div className="px-16 py-12 text-center flex flex-col items-center justify-center">
                ...
                <p className="leading-relaxed text-[#595959] max-w-[420px] mx-auto mb-8">
                    Your submission was successful and is under review. Verification usually takes less than 24 hours.
                    You'll be notified once your account is approved.
                </p>
                <button
                    onClick={handleDone}
                    className="bg-[#002A54] hover:bg-[#013463] text-white w-[150px] text-[13px] font-semibold rounded-md px-8 py-3 inline-flex"
                >
                    Done
                </button>
            </div>
